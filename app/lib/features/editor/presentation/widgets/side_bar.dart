        ...
        children: [
            ...
            child: Row(
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Shader Graph", style: GoogleFonts.spaceGrotesk(fontWeight: FontWeight.bold, fontSize: 16, color: AppColors.onSurface)),
                    Text("v2.4.0-alpha", style: GoogleFonts.inter(fontSize: 10, color: AppColors.onSurfaceVariant, letterSpacing: 1)),
                  ],
                )
              ],
            ),
          ...
          Padding(
            ...
            child: ElevatedButton.icon(
              // Создаем ноду по центру при клике на кнопку
              onPressed: () => ref.read(editorProvider.notifier).addColorNode(const Offset(300, 300)),
              icon: const Icon(Icons.add, size: 16, color: AppColors.onSurface),
              label: Text("Add Node", style: GoogleFonts.inter(fontWeight: FontWeight.bold, color: AppColors.onSurface)),
